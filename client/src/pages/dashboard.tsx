                ...
                <GlassCard delay={0.1} noPadding>
                  <div className="p-4 border-b border-zinc-800 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-mono text-xs text-zinc-400 uppercase tracking-wider">Live Operations Feed</span>
                    </div>
                      ...
                      <div key={agent.name} className="flex items-center justify-between py-2 border-b border-zinc-800/50 last:border-0">
                        ...
                        <div className="flex items-center gap-2">
                          <span className={`w-1.5 h-1.5 rounded-full ${
                            agent.color === "emerald" ? "bg-emerald-400" :
        ...
        <footer className="border-t border-zinc-900 py-8">
          <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
            <p className="font-mono text-[10px] text-zinc-600 uppercase tracking-widest">
              Stillfrost Autonomous Holdings
            </p>
            <div className="flex items-center gap-2">
              <LiveIndicator />
              <span className="text-[10px] font-mono text-zinc-600">Systems Online</span>
            </div>
          </div>
        </footer>
      </div>
